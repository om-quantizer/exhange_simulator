...
TICK_INTERVAL = 0.1  # 1ms (example)

# PRE_MARKET_DURATION = 2  # Duration in seconds for pre-market population phase


# Multi-day simulation settings
SEC_PER_DAY = 7200            # 60 seconds = 1 "day" in the simulation
NUM_DAYS = 5                 # How many "days" to simulate total*
...
TER_PERCENT = 5.0  # Orders must lie within ±5% of the daily open price
CIRCUIT_BREAKER_DURATION = 5  # Duration (in seconds) to halt trading after a circuit trigger


OVERNIGHT_GAP_PERCENT = 10      # Maximum additional gap percentage
MIN_OVERNIGHT_GAP_PERCENT = 1  # Minimum gap percentage (absolute) that must be applied
...
GBM_DRIFT_RANGE = (-0.05, 0.05)      # ±0.03% per time step
GBM_VOLATILITY_RANGE = (0.01, 0.01)    # Smaller short-term volatility
